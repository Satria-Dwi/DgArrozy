...
// Fungsi koneksi (lebih aman)
function bukakoneksi()
{
    global $db_hostname, $db_port, $db_username, $db_password, $db_name;

    mysqli_report(MYSQLI_REPORT_OFF); // matikan error bawaan
...
// Sanitasi input (versi lebih aman)
function cleankar($dirty)
{
    $konektor = bukakoneksi();

    $clean = mysqli_real_escape_string($konektor, trim($dirty));
