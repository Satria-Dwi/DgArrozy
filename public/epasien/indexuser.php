    ...
    if (!isset($_SESSION["nm_pasien"])) {
        ...
        while ($rsqueryuser = mysqli_fetch_array($queryuser)) {
            ...
            if (($rsqueryuser["gambar"] == "") || ($rsqueryuser["gambar"] == "-")) {
                ...
                $_SESSION["photo"]      = "http://simrsudarrozy.com/webapps/photopasien/" . $rsqueryuser["gambar"];
            }
        }
    }
} else {
...
<body class="theme-blue">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <img src="images/logo.png" style="height:40px; width:auto; margin-right:10px;">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            box-shadow:0 8px 20px rgba(0,0,0,0.25);">
                ...
                <div style="display:flex;align-items:center;gap:10px;">
                    <img
                        src="<?= 'data: image/jpeg;base64,' . base64_encode(file_get_contents($_SESSION["photo"])); ?>"
                        alt="Photo"
                        style="width:55px;height:55px;border-radius:12px;object-fit:cover;border:2px solid #38bdf8;" />

                    <div style="font-size:12px;color:#38bdf8;font-weight:600;">
                        No.RM : <?= encrypt_decrypt($_SESSION["ses_pasien"], "d"); ?>
                    </div>
                </div>

                <div class="info-container" style="margin-top:10px; position:relative;">

                    <!-- DROPDOWN DI KANAN -->
                    <div class="btn-group user-helper-dropdown"
                        style="position:absolute; right:0; top:0;">
                        <i class="material-icons" data-toggle="dropdown"
                            style="cursor:pointer;font-size:22px;color:#cbd5f5;">
                            keyboard_arrow_down
                        </i>

                        <ul class="dropdown-menu pull-right"
                            style="border-radius:10px;padding:5px 0;box-shadow:0 8px 20px rgba(0,0,0,0.2);">

                            <li>
                                <a href="index.php?act=UpdatePassword" style="display:flex;align-items:center;padding:10px 15px;font-size:13px;">
                            ...
                            <li>
                                <a href="pages/logout.php" style="display:flex;align-items:center;padding:10px 15px;font-size:13px;">
                                    <i class="material-icons" style="margin-right:8px;">input</i>
                                    Log Out
                                </a>
                            </li>
                    ...
                    <div style="padding-right:30px;">
                        ...
                        <div class="email" style="font-size:12px;color:#94a3b8;">
                            <?= $_SESSION["email"]; ?>
                        </div>
                    </div>
    ...
    <div id="real_time_chart" style="height:300px; visibility:hidden;"></div>
