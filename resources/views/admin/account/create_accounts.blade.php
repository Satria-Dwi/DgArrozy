...
@section('content')
    <div class="flex min-h-screen ">
        ...
        <main class="flex-1 p-6 main-content">
            <form class="card-edit" method="POST" action="{{ route('admin.account.store') }}">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select id="role_id" name="role_id" class="w-full border border-gray-300 rounded px-3 py-2" required>
