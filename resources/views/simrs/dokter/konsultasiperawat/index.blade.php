...
@section('content')
    @role(['admin', 'dokter'])
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-slate-800 dark:text-white">
                            Konsultasi Perawat Belum Dijawab
                        </h2>

                        <p class="text-sm text-slate-500 dark:text-slate-400">
                            Daftar konsultasi Perawat yang menunggu respon dokter
                        </p>
                    </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="relative flex-1">
                        ...
                        <input type="text" id="searchKonsultasiPerawat"
            ...
            <div class="overflow-x-auto">
                ...
                ">
                    ...
                    <tbody id="tableKonsultasiPerawat"
                        class="
                    text-sm
                    text-slate-700
                    dark:text-slate-200
            ...
            <div
                ...
                <!-- Pagination -->
                <div id="paginationKonsultasiPerawat"></div>
        ...
        <div class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50" id="modalKonsultasiPerawat" tabindex="-1"
            ...
            <div class="bg-white rounded-lg p-4 lg:p-6 w-[98%] max-w-7xl max-h-[90vh] overflow-y-auto relative"
                ...
                <div class="flex flex-col lg:flex-row gap-6 items-start">
                    ...
                    <div class="flex flex-col lg:flex-row gap-6 items-start">
                        <!-- KIRI : DETAIL -->
                        <div class="flex-1 bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                            ...
                            <div class="relative p-8">
                                ...
                                <div class="bg-gradient-to-r from-slate-50 to-blue-50 border border-blue-100 rounded-2xl p-5">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div id="modalSituation" class="font-medium">
                                            </div>
                                        </div>
                                ...
                                <div class="mb-6 mt-6">
                                    ...
                                    <div
                                        ...
                                        <p id="modalBackground" class="text-slate-700 leading-relaxed">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-white border-l-4 border-blue-500 rounded-xl p-5 shadow-sm">
                                        <p id="modalAssessment" class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-white border-l-4 border-blue-500 rounded-xl p-5 shadow-sm">
                                        <p id="modalRecomendation" class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex justify-end">
                                    ...
                                    <div class="bg-slate-50 border rounded-2xl p-5 w-72 shadow-sm">
                                        ...
                                        <div class="mt-4 border-t">
                                            ...
                                            <div id="modalPerawat" class="font-bold text-slate-800 text-xs text-center">
                                            </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-200 shadow-lg p-6">
                            ...
                            <div class="relative border-l-2 border-gray-300 ml-4 pl-6">
                                ...
                                <div class="relative mb-8">
                                    ...
                                    <div class="text-sm text-gray-600 mt-1" id="modalSituationTimeLine">
                                    </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg overflow-hidden mt-6">
            ...
            <div
                ...
                <div
                    ...
                    <div class="relative flex-1">
                        ...
                        <input type="text" id="searchKonsultasiSelesaiPerawat"
                            placeholder="Cari nama pasien, No. RM atau No. Permintaan..."
                            class="
                                w-full
                                pl-11
                    ...
                    <div class="relative min-w-[220px]">
                        ...
                        <input type="date" id="tanggalKonsultasiSelesaiPerawat"
                            class="
                    w-full
                    py-3
                    px-4
                ...
                ">
                    ...
                    <button type="button"
                        onclick="
                        document.getElementById('searchKonsultasiSelesaiPerawat').value='';
                        document.getElementById('tanggalKonsultasiSelesaiPerawat').value='';
            ...
            <div class="overflow-x-auto">
                ...
                ">
                    ...
                    <tbody id="tableKonsultasiPerawatSelesai"
                        class="
                    text-sm
                    text-slate-700
                    dark:text-slate-200
            ...
            <div
                ...
                ">
                        ...
                        <div id="infoKonsultasiPerawatSelesai"
                            class="
                    text-xs
                    text-slate-500
                    dark:text-slate-400
                ...
                <!-- Pagination -->
                <div id="paginationKonsultasiPerawatSelesai"></div>
        ...
        <div class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50" id="modalHistoryKonsultasiPerawat"
                        ...
                        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                            ...
                            <div class="relative p-8">
                                ...
                                <div class="bg-gradient-to-r from-slate-50 to-blue-50 border border-blue-100 rounded-2xl p-5">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div id="modalHistorySituation" class="font-medium">
                                            </div>
                                        </div>
                                ...
                                <div class="mb-6 mt-6">
                                    ...
                                    <div
                                        class="bg-gradient-to-r from-amber-50 to-yellow-50 border-l-4 border-amber-500 rounded-xl p-5">
                                        <p id="modalHistoryBackground" class="text-slate-700 leading-relaxed">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-white border-l-4 border-blue-500 rounded-xl p-5 shadow-sm">
                                        <p id="modalHistoryAssessment" class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-white border-l-4 border-blue-500 rounded-xl p-5 shadow-sm">
                                        <p id="modalHistoryRecomendation" class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex justify-end">
                                    ...
                                    <div class="bg-slate-50 border rounded-2xl p-5 w-72 shadow-sm">
                                        ...
                                        <div class="mt-4 border-t">
                                            ...
                                            <div id="modalHistoryPerawat" class="font-bold text-slate-800 text-xs text-center">
                                            </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-200 shadow-lg p-6">
                            ...
                            <div class="relative border-l-2 border-emerald-300 ml-4 pl-6">
                                ...
                                <div class="relative mb-8">
                                    ...
                                    <div class="text-sm text-gray-600 mt-1" id="modalHistorySituationTimeLine">
                                    </div>
        ...
        <div class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50" id="modalKonsultasiPerawatHistoryJawaban"
                            ...
                            <div class="relative p-8">
                                ...
                                <div class="flex justify-between border-b pb-4 mb-6">
                                    <div>
                                        ...
                                        <div id="modalHistoryPerawatJawabanNoPermintaan"
                                            class="inline-flex px-4 py-2 rounded-full bg-blue-100 text-blue-700 font-semibold">
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <div id="modalHistoryPerawatJawabanTindakLanjut" class="font-semibold text-slate-700">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <p id="modalHistoryPerawatJawaban" class="font-bold text-lg text-slate-900">
                                    </p>
                                ...
                                <div class="bg-gradient-to-r from-slate-50 to-blue-50 border border-blue-100 rounded-2xl p-5">
                                    ...
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <div>
                                            <div id="modalHistoryPerawatJawabanPasien" class="font-bold text-lg text-slate-800">
                                            </div>

                                            <div
                                                class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-xs font-medium">
                                                RM : <span id="modalHistoryPerawatJawabanNoRM" class="ml-1"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div id="modalHistoryPerawatJawabanSituation" class="font-medium">
                                            </div>
                                        </div>
                                ...
                                <div class="mb-6 mt-6">
                                    ...
                                    <div
                                        class="bg-gradient-to-r from-amber-50 to-yellow-50 border-l-4 border-amber-500 rounded-xl p-5">
                                        <p id="modalHistoryPerawatJawabanBackground" class="text-slate-700 leading-relaxed">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="bg-white border-l-4 border-blue-500 rounded-xl p-5 shadow-sm">
                                        <p id="modalHistoryPerawatJawabanAssessment"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div
                                        ...
                                        <p id="modalHistoryPerawatJawabanRecomendation"
                                            class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div
                                        ...
                                        <p id="modalHistoryPerawatrespon"
                                            class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div
                                        ...
                                        <p id="modalHistoryPerawatinstruksi"
                                            class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div
                                        ...
                                        <p id="modalHistoryPerawatrencana"
                                            class="text-slate-700 leading-relaxed whitespace-pre-line">
                                        </p>
                                ...
                                <div class="mt-6 flex justify-end">
                                    ...
                                    <div class="bg-slate-50 border rounded-2xl p-5 w-72 shadow-sm">
                                        ...
                                        <div class="text-xs text-slate-500 mb-3">
                                            <span id="modalHistoryPerawatJawabanTanggalTTD"></span>
                                        </div>

                                        <div class="flex justify-center">

                                            <div class="bg-white rounded-xl p-2 shadow border">
                                                <div id="qrTtdHistoryPerawatJawaban"></div>
                                            </div>
                                        ...
                                        <div class="mt-4 border-t">
                                            ...
                                            <div id="modalHistoryPerawtatJawabanDokterPenjawab"
...
@endsection
@section('scripts')
    <script src="{{ asset('js/simrs/dokter/konsultasidariperawat.js') }}"></script>
